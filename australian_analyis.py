...
combined_df.to_csv('cleaned_australian_data.csv', index=False)
...
#Sort thw resultDataFrame by partticipant in ascending order
resultDataFrame = resultDataFrame.sort_values(by='participant')

#Export the resultDataFrame to a new CSV file
resultDataFrame.to_csv('australian_results.csv', index=False)
